      ...
      <div className="h-screen w-screen bg-gray-100 flex items-center">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
          <div className="max-w-md">
            ...
            <p className="text-2xl md:text-3xl font-light leading-normal">Sorry you can't access this page. </p>
            <p className="mb-8">But dont worry, you can find plenty of other things on our dashboard</p>
            <Link
              to="/dashboard"
